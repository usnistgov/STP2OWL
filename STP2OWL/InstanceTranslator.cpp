...
void InstanceTranslator::Translate()
{
...
void InstanceTranslator::AddPropertyAssertions(Individual* indvl, SDAI_Application_instance_ptr inst)
{
	...
	for (int i = 0; i < attrCnt; ++i)
	{
		try
		{
			...
			//if (indvl->GetClassTypeAt(0)->GetName() == "cartesian_point"
			//	|| indvl->GetClassTypeAt(0)->GetName() == "direction")
			//{
...
void InstanceTranslator::AddPropertyAssertionsForCoordinatesList(string aggrIndvlName, string str)
{
